...
const props = defineProps({
    ...
    durationData: { type: Array, required: true },
        ...
        datasets: [
            {
                type: 'bar',
                label: 'Duration (min)',
                data: props.durationData,
                backgroundColor: 'rgba(56, 186, 248, 0.8)', // Sky Blue
                borderColor: '#0ea5e9',
                borderWidth: 1,
                borderRadius: 4,
                yAxisID: 'y'
...
const chartOptions = computed(() => ({
    ...
    scales: {
        ...
        y: {
            ...
            title: { display: true, text: 'Duration (min)', color: '#0ea5e9', font: { size: 10 } }
        },
        y1: {
            type: 'linear',
            display: true,
            ...
            ticks: { maxTicksLimit: 5, color: '#9ca3af', font: { size: 11 } },
            title: { display: true, text: 'Calories (kcal)', color: '#ea580c', font: { size: 10 } }
        }
    },
